    ...
    <main className="min-h-screen bg-[#07101e] px-4 py-12 text-white sm:px-6">
      <article className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-slate-950/55 p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-300">
          ...
          <section><h2 className="text-lg font-bold text-white">Contact</h2><p className="mt-2">CarScout is operated by the owner of carscout.uk. Privacy questions and complaints can be submitted through <Link href="/support" className="font-semibold text-sky-300">Report a problem</Link>. Business address details will be added if CarScout begins trading as a registered business.</p></section>
