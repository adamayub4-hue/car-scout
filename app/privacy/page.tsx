    ...
    <main className="min-h-screen bg-[#07101e] px-4 py-12 text-white sm:px-6">
      <article className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-slate-950/55 p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-300">
          ...
          <section><h2 className="text-lg font-bold text-white">Vehicle registrations</h2><p className="mt-2">Registration lookup is not currently available. If it is enabled later, this notice will be updated before registrations are accepted.</p></section>
          ...
          <section><h2 className="text-lg font-bold text-white">Service providers and international processing</h2><p className="mt-2">Mekivo uses Vercel for hosting and Supabase for authentication and database services. Those providers may process technical and account information under their own data-processing and security terms.</p></section>
