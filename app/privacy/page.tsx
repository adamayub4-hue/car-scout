    ...
    <main className="min-h-screen bg-background px-4 py-12 text-foreground sm:px-6">
      <article className="mx-auto max-w-3xl rounded-3xl border border-outline/10 bg-panel/95 p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-muted">
          ...
          <section><h2 className="text-lg font-bold text-foreground">Cookies and local storage</h2><p className="mt-2">Mekivo uses browser storage to keep an account signed in, remember your appearance preference and retain campaign attribution during your visit. It does not currently use advertising cookies or operate a payment system. Hosting providers may process standard technical logs needed to operate and secure the service.</p></section>
          ...
          <section><h2 className="text-lg font-bold text-foreground">Website analytics</h2><p className="mt-2">Mekivo uses Vercel Web Analytics and Speed Insights to understand visits, performance and actions such as searches and marketplace clicks. Campaign labels in a link help us understand which posts and adverts brought visitors to the site. Custom analytics events do not include raw registration numbers, account email addresses or free-text searches. Signed-in account activity is recorded separately as described above.</p></section>
